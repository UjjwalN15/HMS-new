...
urlpatterns = [
    ...
    path('staff_position/', Staff_PositionApiView.as_view({'get': 'list','post':'create'}),name='staff_position'),
    path('staff_position/<int:pk>/', Staff_PositionApiView.as_view({'get': 'retrieve', 'put':'update','patch': 'partial_update', 'delete':'destroy'}),name='staff_position'),
    path('users/', UserApiView.as_view({'get': 'list'}),name='users'),
    path('users/<int:pk>/', UserApiView.as_view({'get': 'retrieve'}),name='users'),
